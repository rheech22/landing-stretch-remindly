    ...
    <>
      ...
      >
        <div className="space-y-4 text-foreground">
          ...
          <p>
            By downloading, installing, or using Stretching Remindly, you agree
          ...
          <p>
            Stretching Remindly is a macOS application designed to remind users
            to take stretching breaks during computer work sessions. The
            application provides timers, stretching guides, and customizable
            settings to promote healthy work habits.
          </p>

          <h3 className="text-lg font-semibold">3. User Accounts</h3>
          <p>
            Stretching Remindly does not require user accounts for basic
            functionality. Any optional account features that may be added in
            the future will be subject to additional terms.
          </p>
          ...
          <p>
            ...
            Application for your personal, non-commercial purposes. You may not:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Transfer, sublicense, lease, lend, rent or otherwise distribute
          ...
          <p>
            The Application may include open source components. Any use of open
            source components is governed by the applicable open source
            licenses.
          </p>

          <h3 className="text-lg font-semibold">6. Disclaimer of Warranties</h3>
          <p>
            THE APPLICATION IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND. WE
          ...
          <p>
            ...
            DAMAGES WHATSOEVER ARISING OUT OF OR RELATED TO YOUR USE OF OR
